...
async function load() {
  let res = await fetch(
    "https://raw.githubusercontent.com/pccoeacm/data-store/main/events.json"
  );
  ...
  data.forEach((el) => {
    $(".cards").append(`
     <div class="card" data-route=${el.eventName
       .split(" ")
...
console.log(
  `%cHelp me I'm stuck in console ○( ＾皿＾)っ`,
